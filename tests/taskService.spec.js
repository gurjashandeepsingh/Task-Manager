...
describe("TaskServices", () => {
  // create a task with valid parameters and check if it is created and returned correctly
  it("should create a task with valid parameters and return the newly created task", async () => {
    // Arrange
    const title = "Task 1";
    ...
    jest.spyOn(Task, "create").mockResolvedValue(newTask);
    newTask.save = jest.fn().mockResolvedValue(newTask);
